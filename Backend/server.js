...
app.post('/sendmail', function (req, res) {
  ...
  if (req.body.subject === 'partnership') {
    contactForm.to = config.partnershipMail;
  }

  transporter.sendMail(contactForm, (error, response) => {
    if (error) {
      return console.log(error);
      res.json({error: "API Error"});
    } else {
      console.log("The message is sent to: " + contactForm.to);
